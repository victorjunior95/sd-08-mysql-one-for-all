...
CREATE TABLE IF NOT EXISTS `SpotifyClone`.`usuario` (
    ...
    CONSTRAINT `fk_usuario_plano1` FOREIGN KEY (`id_plano`) REFERENCES `SpotifyClone`.`plano` (`id_plano`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `SpotifyClone`.`album` (
    ...
    CONSTRAINT `fk_album_artista1` FOREIGN KEY (`id_artista`) REFERENCES `SpotifyClone`.`artista` (`id_artista`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `SpotifyClone`.`cancao` (
    ...
    CONSTRAINT `fk_cancao_album1` FOREIGN KEY (`id_album`) REFERENCES `SpotifyClone`.`album` (`id_album`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `SpotifyClone`.`historico_reproducao` (
    ...
    CONSTRAINT `fk_historico_reproducao_cancao1` FOREIGN KEY (`id_cancao`) REFERENCES `SpotifyClone`.`cancao` (`id_cancao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_historico_reproducao_usuario1` FOREIGN KEY (`id_usuario`) REFERENCES `SpotifyClone`.`usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `SpotifyClone`.`usuario_artista` (
    ...
    CONSTRAINT `fk_usuario_artista_usuario1` FOREIGN KEY (`id_usuario`) REFERENCES `SpotifyClone`.`usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_usuario_artista_artista1` FOREIGN KEY (`id_artista`) REFERENCES `SpotifyClone`.`artista` (`id_artista`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
