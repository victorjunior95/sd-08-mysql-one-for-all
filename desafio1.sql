...
INSERT INTO pass (pass_name, pass_value)
	VALUES
		ROW('gratuito', 0),
        ROW('familiar', 7.99),
        ROW('universitário', 5.99);
...
INSERT INTO user_pass (user_id, pass_id)
	VALUES
		ROW(1, 1),
        ROW(2, 2),
        ROW(3, 3),
...
INSERT INTO musics (music_name)
	VALUES
		ROW('Celebration Of More'),
        ROW('Dance With Her Own'),
        ROW('Diamond Power'),
        ROW('Fantasy For Me'),
        ROW('Home Forever'),
        ROW("Honey, Let's Be Silly"),
        ROW('Honey, So Do I'),
        ROW('Magic Circus'),
        ROW('Reflections Of Magic'),
        ROW('Rock His Everything'),
        ROW('She Knows'),
        ROW('Soul For Us'),
        ROW("Sweetie, Let's Go Wild"),
        ROW('Thang Of Thunder'),
        ROW('Time Fireworks'),
        ROW('Troubles Of My Inner Fire'),
        ROW('Without My Streets'),
        ROW('Words Of Her Life');
...
INSERT INTO album_musics (album_id, music_id)
	VALUES
		ROW(1, 2),
        ROW(1, 9),
        ROW(1, 12),
...
INSERT INTO artiste_user(artiste_id, user_id)
	VALUES
     ROW(1, 1),
     ROW(1, 4),
     ROW(2, 1),
